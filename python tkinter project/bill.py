...
class Bill_App:
    def __init__(self,root):
        ...
        cname_lbl= Label(F1, text="Phone No.", bg=bg_color, fg="white", font=("times new roman", 18, "bold")).grid( row=0, column=2, padx=20, pady=5)
        cname_txt = Entry(F1, width=15, textvariable=self.c_phon, font="arial 15", bd=7, relief=SUNKEN).grid(row=0, column=3, pady=5, padx=10)

        cname_lbl=Label(F1, text="Bill No.", bg=bg_color, fg="white", font=("times new roman" , 18,"bold")).grid( row=0, column=4, padx=20, pady=5)
        ...
        bill_btn=Button(F1, text="Search" , command=self.find_bill, textvariable=self.search_bill, width=15 , bd=7, font="arial 12 bold").grid(row=0,column=6,pady=10, padx=10)
        ...
        #============Final Price and Tax Button=============

        F6 = LabelFrame(self.root, bd=10, relief=GROOVE, text="Bill Menu ", font=("times new roman", 15, "bold"),fg="gold", bg=bg_color)
        F6.place(x=0, y=560, relwidth=1, height=140)

       #============Below labels of total each category prices=============
        ...
        #=============== Bottom Last line Button frame=============

        btn_F=Frame(F6, bd=7, relief=GROOVE)
        btn_F.place(x=750, width=580, height=105)

        #============= Total,Generate bill,clear,exit buttons==========

        total_btn = Button(btn_F, command=self.total, text="Total", bg="cadetblue", fg="black", bd=5, pady=15, width=11, font="arial 14 bold").grid(row=0,column=0, padx=5 ,pady=5)
        gbill_btn = Button(btn_F, text="Generate Bill", command=self.bill_area, bg="cadetblue", fg="black", bd=5, pady=15, width=11,font="arial 14 bold").grid(row=0, column=1, padx=5, pady=5)
        clear_btn = Button(btn_F, text="Clear", command=self.clear_data, bg="cadetblue", fg="black", bd=5, pady=15, width=11,font="arial 14 bold").grid(row=0, column=2, padx=5, pady=5)
        exit_btn = Button(btn_F, text="Exit", command=self.Exit_app, bg="cadetblue", fg="black", bd=5, pady=15, width=11, font="arial 14 bold").grid(row=0, column=3, padx=5, pady=5)
        self.welcome_bill()
    ...
    def total(self):
        ...
        self.c_tax = round((self.total_cosmetic_price*0.10),2)
        ...
        self.d_tax = round((self.total_cold_drink_price * 0.09),2)
    ...
    def welcome_bill(self):
        ...
        self.txtarea.insert(END,"\tWelcome Storex Retail")
    ...
    def bill_area(self):
        if self.c_name.get()=="" or self.c_phon.get()=="":
            ...
            #=============End Section of the bill Final Taxes and Total Bill==========
            self.txtarea.insert(END, f"\n-------------------------------------------")
